      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextField, { label: "\uC0AC\uBC88", value: empNo, onChange: setEmpNo, placeholder: "Q1051" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextField, { label: "\uC131\uBA85", value: name, onChange: setName, placeholder: "\uD64D\uAE38\uB3D9" }),
            isHead ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextField, { label: "\uC9C1\uAE09", value: position, onChange: setPosition, placeholder: "\uD488\uC9C8\uBD80\uC11C\uC7A5" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextField, { label: "\uC9C1\uAE09", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "select",
              {
                value: position,
        ...
        data.teams.map((team, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          TeamCard,
          {
            ...
            onAddMember: (d) => updateTeams(
              (teams) => teams.map(
                (t) => t.id === team.id ? { ...t, members: [...t.members, { id: nextId(), ...d, factory, status: "\uCD9C\uADFC" }] } : t
              )
            ),
            onEditMember: (memberId, d) => updateTeams(
              (teams) => teams.map(
                (t) => t.id === team.id ? { ...t, members: t.members.map((m) => m.id === memberId ? { ...m, ...d } : m) } : t
              )
            ),
            onDeleteMember: (memberId) => {
              if (confirm("\uC774 \uD300\uC6D0\uC744 \uC0AD\uC81C\uD560\uAE4C\uC694?")) {
                updateTeams(
                  (teams) => teams.map((t) => t.id === team.id ? { ...t, members: t.members.filter((m) => m.id !== memberId) } : t)
                );
              }
            }
          },
  ...
  function QualityPortal() {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { background: COLORS.page, minHeight: "100%", fontFamily: "var(--font-sans, sans-serif)" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { maxWidth: 1400, margin: "0 auto", padding: "20px 20px 40px" }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 20, borderBottom: `0.5px solid ${COLORS.border}`, marginBottom: 18 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabBtn, { value: "dashboard", label: "\uB300\uC2DC\uBCF4\uB4DC", icon: "\u25A6" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabBtn, { value: "org", label: "\uC870\uC9C1\uB3C4", icon: "\u{1F5C2}" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabBtn, { value: "list", label: "\uC804\uCCB4 \uBA85\uB2E8", icon: "\u2261" })
      ] }),
      tab === "dashboard" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, minmax(0,1fr))", gap: 12, marginBottom: 18 }, children: ["\uCD9C\uADFC", "\uACB0\uADFC", "\uBCD1\uAC00", "\uCD9C\uC0B0\uD734\uAC00"].map((s) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { background: COLORS.card, border: `0.5px solid ${COLORS.border}`, borderRadius: 12, padding: "14px 16px" }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 12, color: COLORS.textSecondary }, children: s }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { background: COLORS.card, border: `0.5px solid ${COLORS.border}`, borderRadius: 12, padding: "16px 18px" }, children: [
          ...
          notices.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 13, color: COLORS.textMuted }, children: "\uC624\uB298\uC740 \uC804\uC6D0 \uC815\uC0C1 \uCD9C\uADFC\uD588\uC2B5\uB2C8\uB2E4." }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: notices.map((e) => {
            ...
            if (e.status === "\uBCD1\uAC00" && e.note) detail += ` \xB7 \uC0AC\uC720: ${e.note}`;
            if (e.status === "\uCD9C\uC0B0\uD734\uAC00" && e.returnDate) detail += ` \xB7 \uBCF5\uADC0\uC608\uC815\uC77C: ${e.returnDate}`;
            return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
              "div",
              {
                style: {
      ...
      tab === "list" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { background: COLORS.card, border: `0.5px solid ${COLORS.border}`, borderRadius: 12, padding: "16px 18px" }, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { fontSize: 12, color: COLORS.textMuted, marginBottom: 8 }, children: [
          "\uCD1D ",
          filteredList.length,
          "\uBA85"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "\uC0AC\uBC88" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "\uC131\uBA85 / \uC18C\uC18D" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "\uC9C1\uAE09" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "\uACF5\uC7A5" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "\uBE44\uACE0" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { textAlign: "right" }, children: "\uC624\uB298 \uC0C1\uD0DC" })
              ]
            }
          ),
          filteredList.map((e) => {
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { minWidth: 0 }, children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 11, color: COLORS.textMuted }, children: e.team })
                  ] }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 12, color: COLORS.textSecondary }, children: e.position }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { fontSize: 12, color: COLORS.textSecondary }, children: [
                    e.factory,
                    "\uACF5\uC7A5"
                  ] }),
